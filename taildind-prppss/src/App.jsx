...
function App() {
  ...
  return (
    <>
     ...
     <h1 className='bg-red-400 rounded-lg'> Tailwind test</h1>
     <div class="flex font-sans mt-2">
  <div class="flex-none w-56 relative">
    <img src="https://images.pexels.com/photos/12987878/pexels-photo-12987878.jpeg?auto=compress&cs=tinysrgb&w=300&lazy=load" alt="" class="absolute inset-0 w-full h-full object-cover rounded-lg" loading="lazy" />
  </div>
  <form class="flex-auto p-6">
    <div class="flex flex-wrap">
      <h1 class="flex-auto font-medium text-red-900">
        Kids Jumpsuit
      </h1>
    ...
    <div class="flex space-x-4 mb-5 text-sm font-medium">
      <div class="flex-auto flex space-x-4">
        ...
        <button class="h-10 px-6 font-semibold rounded-full border border-slate-200 text-red-900" type="button">
          Add to bag
        </button>
      </div>
